                    ...
                    <div class="card-container m-2 flex grid-cols-2 rounded-md">
                        <div class="grid grid-row-2 ">
                            ...
                            <div class="card-image">
                                <img :src="fileUrl + prod_card_details.collectionId + '/' + prod_card_details.id + '/' + prod_card_details.product_img"
                                    alt="" class="h-52 w-full rounded-t-lg img-prod-prev">
                            </div>
                                ...
                                <div class="card-controller p-3">
                                    <div class="buttons f">
                                        <div class="add-to-car">
                                            <button @click="addToCart(index, parseInt(prod_card_details.product_price))"
                                                class="bg-black text-white p-2 rounded-md hover:-translate-y-1 duration-200">Add
                                                to Cart</button>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    data() {
        return {
            // cow: 'https://ecommerce.forkbun.evansolanoy.studio/api/files/136m0uq5sta9cyo/pyb9xr0qbcoeejj/nyx_ixs3Kshd75.jpg',
            productGet: this.productProp,
            fileUrl: 'https://ecommerce.forkbun.evansolanoy.studio/api/files/',
            ordered_prod_card: [],
        }
    },
    methods: {
